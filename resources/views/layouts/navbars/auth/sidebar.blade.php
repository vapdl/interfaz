<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            @if(!is_null(auth()->user()->academy))
                <img src="{{asset('storage/'.auth()->user()->academy->logo)}}" class="navbar-brand-img h-100" alt="...">
                <span class="ms-3 font-weight-bold">{{auth()->user()->academy->name}}</span>
            @else
                <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="...">
                <span class="ms-3 font-weight-bold">Dashboard Natacion</span>
            @endif
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'academies' ? 'active' : '' }}"
                   href="{{ route('academies') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Academias</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'athletes' ? 'active' : '' }}"
                   href="{{ route('athletes') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                    ...
                    <span class="nav-link-text ms-1">Atletas</span>
                </a>
            </li>
            <li class="nav-item pb-2">
